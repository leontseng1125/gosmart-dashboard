  ...
  <script>
    ...
    onHudBootDone(function () {
      ...
      const LINES = [
        ...
        '深空雷達回報：有位用戶為了藍牙開鎖在停車場繞了 20 分鐘……阿葛格已將其標註在旅程第 7 節點。',
        '連續點擊我並不能讓版本評分回到 5 星，但能提升少尉的心跳頻率。',
        '警告：設計師的咖啡存量已低於 15%，建議立即返航補給。'
      ];
      let clickTimes = [];
      let hideTimer = null;
      function hideDialog() {
      ...
      function showDialog() {
        bodyEl.textContent = LINES[Math.floor(Math.random() * LINES.length)];
